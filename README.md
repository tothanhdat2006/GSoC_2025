...
- The outliers are detected by determining paintings with low confidence score (in this case, the chosen threshold is *0.25*) predicted by the models. The results are shown in the below image
![Style Outliers](Task1/experiment/images/style_outliers.png)
